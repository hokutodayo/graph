...
function setup() {
    ...
    function applyDegreeSequence() {
        if (graphManager.degreeSequence.vertexCount() > 1000) {
            _common_utils__WEBPACK_IMPORTED_MODULE_0__.Utils.confirmAction("頂点の数が100を超えるグラフは描画できません", () => { });
        }
