        ...
        if (file) {
            ...
            reader.onload = function (event) {
                ...
                try {
                    ...
                    _common_utils__WEBPACK_IMPORTED_MODULE_0__.Utils.errorAction("JSONデータのインポート中にエラーが発生しました: " + error.message);
                }
            };
            // ファイル読み込みエラーのハンドラ
