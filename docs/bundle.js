...
class GraphManager {
    ...
    importFromJson(jsonString) {
        ...
        this.vertices = importData.vertices.map((vData) => new _object_Vertex__WEBPACK_IMPORTED_MODULE_2__.Vertex(vData.x, vData.y));
        this.edges = importData.edges.map((eData) => {
            const fromVertex = this.vertices[eData.from];
            const toVertex = this.vertices[eData.to];
            const edge = new _object_Edge__WEBPACK_IMPORTED_MODULE_1__.Edge(fromVertex, toVertex);
...
/* harmony import */ var _DegreeSequence___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DegreeSequence  */ "./src/DegreeSequence .ts");
/* harmony import */ var _GraphManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./GraphManager */ "./src/GraphManager.ts");
...
clearGraphButton.addEventListener("click", () => {
    sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        ...
        if (result.isConfirmed) {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire("実行完了!", "グラフが初期化されました。", "success");
        }
    });
});
// オブジェクト情報の更新
...
straightenEdgesButton.addEventListener("click", () => {
    sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        ...
        if (result.isConfirmed) {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire("実行完了!", "すべての辺が直線になりました。", "success");
        }
    });
});
// ============================================================================
